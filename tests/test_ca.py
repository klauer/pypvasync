...
def _array_callback(arrayname, array_type, length, element_type):
...
def test_subscription_char_array():
    ...
    _array_callback(pvnames.char_arr_pv, numpy.ndarray, 128, numpy.uint8)
